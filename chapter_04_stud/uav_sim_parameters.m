...
windStatic = zeros(3,1); % [5 -4 0]'; % [-3 2 0]';
windsigma = zeros(3,1); % [3 3 3]'; % [1.06 1.06 0.7]';
windL = [533 533 533]'; % [200 200 50]';

uavParams = makeUavParameters;

function uavParams = makeUavParameters
